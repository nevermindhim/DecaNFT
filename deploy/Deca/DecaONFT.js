...
module.exports = async function ({ deployments, getNamedAccounts }) {
    ...
    await deploy("DecaONFT", {
        from: deployer,
        args: ["", "DecaONFT", "DNFT", 100000, lzEndpointAddress], // mainnet
        log: true,
        waitConfirmations: 3,
        skipIfAlreadyDeployed: true
    })
/*
    let onft = await ethers.getContract("DecaONFT")
...
*/
    await hre.run("verifyContract", { contract: "DecaONFT" })
}

module.exports.tags = ["DecaONFT"]
