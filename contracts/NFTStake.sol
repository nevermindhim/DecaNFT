...
import "./interfaces/IDecaFT.sol";
import "./interfaces/IDecaNFT.sol";

/// @title the DecaNFT staking vault
/// @author ScottBlockchainDev
/// @notice this vault allwos users to stake their DecaNFT tokens and earn daily rewards
/// based on their overall staking period, the rewards are distributed in the form of our own ERC20 token 'DecaFT'
/// @dev this contract must be set as controller in the 'DecaFT' contract to enable ERC20 rewards minting
...
contract NFTStake is IERC721Receiver {
    ...
    IDecaNFT immutable nft;
    IDecaFT immutable token;
    ...
    constructor(address _nftAddress, address _tokenAddress) {
        nft = IDecaNFT(_nftAddress);
        token = IDecaFT(_tokenAddress);
    }
